...
<body>
	...
	<div class="topnav">
		<a href="AddTrainer">New Trainer</a> <a href="SearchTrainers">Look Up</a> <a href="Home">Home</a>
	</div>
	<div class="content">
		<div>
		...
		<form action="CreateTeam" method="post">
			<c:forEach var="i" begin="1" end="6">
				<div class="row">
					<div class="col">
						<label for="pokemon">Pokemon ${i}</label>
						<select id="pokemon" size="10" name="pokemon">
